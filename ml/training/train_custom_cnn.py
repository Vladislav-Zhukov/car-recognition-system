...
def train_one_epoch(model, loader, criterion, optimizer):
    ...
    for images, labels in tqdm(loader, desc="Training CustomCNN"):
...
def validate(model, loader, criterion):
    ...
    with torch.no_grad():
        for images, labels in tqdm(loader, desc="Validation CustomCNN"):
            images = images.to(DEVICE)
            labels = labels.to(DEVICE)
...
def main():
    ...
    print(f"Classes count: {len(train_dataset.classes)}")
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            print(f"Best CustomCNN saved: {CUSTOM_CNN_MODEL_PATH}")
